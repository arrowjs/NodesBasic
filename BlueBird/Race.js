...
//So sánh với ví dụ Any2.js. Race thì trả về kết quả
//nào sớm nhất bất kể là thất bại hay thành công.
//Còn any trả về kết quả thành công sớm nhất

promise.race(photoLinks.map(function(photoLink) {
